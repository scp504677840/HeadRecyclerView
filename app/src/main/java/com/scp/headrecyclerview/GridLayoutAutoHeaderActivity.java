 ...
 * 带头布局的自动布局
 */
public class GridLayoutAutoHeaderActivity extends AppCompatActivity {
    @Override
    ...
    private void initView() {
        ...
        //获取头布局
        View header = LayoutInflater.from(this).inflate(R.layout.auto_fit_header, mAutoFitRecyclerView, false);
        header.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(GridLayoutAutoHeaderActivity.this, "我是头布局", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //设置显示方式
        final GridLayoutManager manager = (GridLayoutManager) mAutoFitRecyclerView.getLayoutManager();
